...
// beadPrefix extracts the configured prefix from a bead ID, delegating to
// sling.BeadPrefix so hyphenated prefixes ("pieces-annotator-x8o" →
// "pieces-annotator") resolve consistently between the CLI and the API.
